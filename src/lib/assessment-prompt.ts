...
출력 예:
  damage_type: "2유형"
  reasoning: "도장막 손상까지는 확인되나 소재 변형(함몰) 여부는 사진 각도상
    단정하기 어려움. 뚜렷한 함몰 음영이 보이지 않아 2유형(판금 비대상)에
    가깝다고 판단하나, 3유형(소재 손상)일 가능성도 배제할 수 없음"
  evidence_confidence: "낮음"
  verdict: "협의대상"
  required_action: "근접/측광 사진 추가 확보해 소재 변형 여부 최종 확인 필요"
