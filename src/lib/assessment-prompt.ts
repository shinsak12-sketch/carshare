...
export const PROMPT_VERSION_TAG = "v1.3";
...
유형) 판정이지만, 선견적에 다른 항목(방청제, 잔존물공제, 감가상각, 대차료/휴차료,
ADAS검교정, 타이어 등)이
...
8. [추가 참고자료]로 제공된 도메인(방청제, 잔존물공제, 감가상각, 대차료/휴차료,
   ADAS검교정, 타이어 등)에
...
2. (선택) 선견적 원문 텍스트: 부위, 작업유형(교환/판금/탈착/도장), 청구H, 부품코드, 차종, 방청제/대차료 등 기타 항목
3. (선택) [추가 참고자료]: 선견적 내용을 보고 관련 있다고 판단된 도메인(방청제,
   잔존물공제, 감가상각, 대차료/휴차료, ADAS검교정, 타이어 등)의 기준 자료.
   자동으로 선별되어 제공되므로, 여기 없는 도메인은 선견적에 없거나 판단
   근거가 없다는 뜻입니다.
