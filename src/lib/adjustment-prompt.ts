...
5. 부품 교환 "공임"(램프·센서·힌지·래치·트림·브라켓 등을 신품으로 바꾸는
   작업)은 그 부품의 파손 또는 신품 장착 증거로 판단하되, "협의필요"를
   남발하지 말고 사진 속 신품 여부(보호필름, 라벨, 신품 광택, 구품 옆에 놓인
   모습)를 실제로 살핀 뒤 결정하십시오. 증거가 없으면 adjustment_note에
