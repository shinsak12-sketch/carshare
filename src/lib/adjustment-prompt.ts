...
export const ADJUSTMENT_PROMPT_VERSION_TAG = "adj4.2";
...
5. reasoning과 adjustment_note는 짧고 실무적으로. "회사 기준 미제공", "표준시간
   ...
   - "인정" 항목의 reasoning은 한 구절(15자 내외, 예: "작업사진 확인", "펜더
     교환에 수반", "긁힘뿐 균열 없음"). 추론 인정은 추론 경로 한 문장, 판금·
     수리 항목은 [판금·수리 시간 판단]의 판독 축 한 줄. adjustment_note는
     빈 문자열 — 한도 0.1H 이하 초과를 인정한 경우의 한도 메모만 예외. 절차
     설명이나 당연한 말은 쓰지 않습니다.
