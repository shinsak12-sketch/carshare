...
const NIRO_AI_RESULT: AssessmentResult = {
  ...
  overall_opinion:
    "리어범퍼어셈블리는 2유형(도장막 손상, 소재 손상 없음)으로 판단되며, 경미손상 판정기준상 " +
    "교환이 아닌 보수도장 대상에 해당합니다. 청구액 557,006원 중 대부분(범퍼 부품비 129,800원 + " +
    "교환·도장 공임 다수)이 '전체 교환' 전제로 산정되어 있으나, 제공된 사진 근거로는 교환을 " +
    "정당화할 소재 손상(파단·천공 등)이 확인되지 않습니다. 실물 확인 또는 근접 사진 추가 확보 " +
    "전까지 협의 대상으로 분류할 것을 권고합니다.",
  disputed_items: [
    "리어범퍼어셈블리 교환 인정 여부",
